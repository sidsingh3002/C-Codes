...
int main()
{
    int flag = 0, i, j, k, n, p1, req1, req2, req3;
    // clrscr();
    ...
    if (req1 <= need1[p1] && req2 <= need2[p1] && req3 <= need3[p1] && avail1 >= req1 && avail2 >= req2 && avail3 >= req3)
    {
        need1[p1] = need1[p1] - req1;
        need2[p1] = need2[p1] - req2;
        need3[p1] = need3[p1] - req3;
        all1[p1] = all1[p1] + req1;
        all2[p1] = all2[p1] + req2;
        all3[p1] = all3[p1] + req3;
        avail1 = avail1 - req1;
        avail2 = avail2 - req2;
        avail3 = avail3 - req3;
